            ...
            {!showForgotPassword ? (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full text-ocean-foam hover:text-sail-white font-medium transition-colors duration-300"
                >
                  Forgot Password? 🧭
                </button>
                ...
                <div className="text-center pt-4 border-t border-border">
                  <p className="text-ocean-foam mb-3">New to Charter Party?</p>
                  <button
                    type="button"
                  ...
                  >
                    Join Our Fleet - Sign Up 🚢
                  </button>
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-sail-white text-center mb-6">
                  🧭 Reset Password
                </h2>
                <div>
                  <label className="block text-ocean-foam font-semibold mb-2">
...
export default CharterPartyLogin;
